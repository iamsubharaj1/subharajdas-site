...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:subharaj@subharajdas.com?subject=${mailtoSubject}&body=${mailtoBody}`;
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="text-slate-300">+91-9742189357</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="text-slate-300">subharaj@subharajdas.com</div>
              </div>
            </div>
